Queries from 18th November

-- database: c:\Users\hdwyer9\OneDrive - NSW Department of Education\11 SW\001_P4W_Omen\IN_SYD_Task_1_Flask_PWA_Template\.database\data_source.db
...
SELECT * FROM extension WHERE extID >= 2;

SELECT name from extension order by name DESC;
